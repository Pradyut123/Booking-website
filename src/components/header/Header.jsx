...
const Header = ({type}) => {
    ...
    const [date, setDate] = useState([
      ...
      const [options, setOptions] = useState({  // stores the initial value of the variables
        adult: 1,
        children: 0,
        room: 1,
      });
      ...
      const handleOption = (name, operation) => {
        setOptions((prev) => {     // takes the previus state eg adult 1, children 0... wont change anything
          return {
            ...prev,
            [name]: operation === "i" ? options[name] + 1 : options[name] - 1, //now it will find the name eg adult and check if the operation
